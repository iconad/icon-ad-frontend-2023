        ...
        <div class="px-5 w-full space-y-10 lg:space-y-20">
              ...
              <div class="theme-container">
                <div class="space-y-5 lg:space-y-10">
                  ...
                  <transition appear>
                      <span class="inline md:inline-block"> Experience <span class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-theme-sky via-theme-purple to-theme-pink"> Reimagined!</span></span>
                ...
                <div class="w-full flex flex-col lg:flex-row lg:items-center space-y-3 lg:space-y-0 lg:space-x-5">
                    ...
                    <nuxt-link to="/advertising/services" class="mx-auto md:mx-0 flex justify-center space-x-4 text-lg lg:text-xl font-medium rounded-full bg-black text-white block w-64 py-[0.35rem] md:py-[0.85rem] border-2 md:border-4 border-black hover:bg-transparent hover:text-black">
                      <span> Services </span>
                    </nuxt-link>
