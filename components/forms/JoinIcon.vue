    ...
    <div>
         ...
         <div class="form-element mt-6">
          ...
          <div class="form-element mt-6">
            ...
            <textarea type="text" class="form-input" v-model="form.perfect" rows="5"></textarea>
          </div>
          ...
          <div class="form-element mt-6">
            <label for="" class="mb-2 ml-1 font-medium block">Link to your portfolio</label>
            <input type="text" v-model="form.portfolio_link" required class="form-input">
          </div>
          <!-- form element -->
          ...
          <div class="space-y-8">
            <div class="form-element mt-12">
              <label for="" class="mb-4 ml-1 font-medium block">Cover letter (upload pdf)</label>
            ...
            <div class="form-element mt-12">
              <label for="" class="mb-4 ml-1 font-medium block">CV (upload pdf)</label>
            ...
            <div v-if="!isLoading" class="form-element mt-12 flex justify-center w-full">
              <input type="submit" class="mx-auto form-button text-white font-medium rounded-xl bg-gradient-to-r from-theme-red via-theme-pink to-theme-purple cursor-pointer hover:bg-opacity-100" value="Submit">
              </div>
              <div v-else>
      ...
      data() {
        return {
          ...
          bindProps: {
            ...
            required: true,
            autocomplete: "on",
            styleClasses:"form-input text-gray-700"
          },
          phone: {
            number: "",
            valid: false,
          ...
          form: {
            name: "",
            email: "",
            subject: "Senior Graphic Designer application from ICON website form",
            perfect: "",
            favorite: "",
            are_you_in_uae: "",
            portfolio_link: "",
      ...
      submitForm (resume, cover) {
        ...
        let config = {
          ...
          this.$axios.$post(`https://drupal.icon-ad.com/webform_rest/submit/?_format=json`, {
                ...
                portfolio_link: this.form.portfolio_link,
