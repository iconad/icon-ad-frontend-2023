<template>
  <div>
        ...
        <div class="flex items-center">
          <div class="w-full space-y-3">
            <div class="text-9xl font-semibold -space-y-8 flex flex-col">
              <span
                class="leading-none icon-rainbow-text pr-2 -tracking-[5px] h-[8.5rem]"
                >Unlock</span
              >
              <span
                class="leading-none icon-rainbow-text pr-2 -tracking-[5px] h-[8.5rem]"
            ...
            <p class="font-medium">
              Check more projects, unlock full case studies, and
              <br class="hidden md:block" />
              showcase how we tackle projects
            </p>
          </div>

          <div class="w-[30rem]">
            <img
              src="https://res.cloudinary.com/dizi8svi8/image/upload/v1692278795/head_gsr0yv.png"
              alt="unloack creativity"
            />
          </div>
        </div>
    ...
    <section class="bb-advertising pt-[15vh] space-y-[10vh]">
      <div
        class="str-advertising translate-x-[26rem] text-[9rem] h-[12rem] font-bold icon-rainbow-text whitespace-nowrap -tracking-[10px] px-4"
      >
...
export default {
  ...
  methods: {
    // setupSplits(element)
    scrollToReveal() {
      this.ctxAdv = this.gsap.context(() => {
        this.gsap.to(".str-advertising", {
          x: "-100%",
          duration: 2,
          scrollTrigger: {
            trigger: ".bb-advertising",
            start: "top 95%",
            end: "+=3800",
            scrub: true,
          },
