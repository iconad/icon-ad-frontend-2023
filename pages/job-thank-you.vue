      ...
      >
        <div>
          <span class="text-green-500">
            <svg
              class="w-16 md:w-16 h-16 md:h-16 mx-auto fill-current"
          ...
          <div class="my-10">
            ...
            <p>
              We have received your application and are reviewing it carefully. We appreciate your interest in joining our team and will be in touch with you regarding the next steps in the hiring process.
            </p>
          </div>
