              ...
              <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8 lg:gap-4 w-full">
                ...
                <div class="rounded-2xl h-24 md:h-32 2xl:h-40 w-full bg-transparent cursor-pointer transition-all duration-300 hover:bg-gradient-to-r from-theme-sky via-theme-purple to-theme-red p-[2px] flex items-center justify-center">
                  <div class="inner bg-theme-gray-1 w-full h-full rounded-2xl flex items-center justify-center">
                    ...
                    <nuxt-link to="/advertising" class="inner bg-theme-gray-1 w-full h-full rounded-2xl text-white text-base md:text-lg font-semibold tracking-wide flex items-center justify-center">
                ...
                <div class="rounded-2xl h-24 md:h-32 2xl:h-40 w-full bg-transparent cursor-pointer transition-all duration-300 hover:bg-gradient-to-r from-theme-sky via-theme-purple to-theme-red p-[2px] flex items-center justify-center">
                  <div class="inner bg-theme-gray-1 w-full h-full rounded-2xl flex items-center justify-center">
                    <nuxt-link to="/digital" class="inner bg-theme-gray-1 w-full h-full rounded-2xl text-white text-base md:text-lg font-semibold tracking-wide flex items-center justify-center">
                      <span> DIGITAL </span>
                    </nuxt-link>
                  </div>
                </div>
                ...
                <div class="rounded-2xl h-24 md:h-32 2xl:h-40 w-full bg-transparent cursor-wait transition-all duration-300 hover:bg-gradient-to-r from-theme-sky via-theme-purple to-theme-red p-[2px] flex items-center justify-center">
                  <nuxt-link to="/branding" class="inner bg-theme-gray-1 w-full h-full rounded-2xl text-white text-base md:text-lg font-semibold tracking-wide flex items-center justify-center">
                ...
                <div class="rounded-2xl h-24 md:h-32 2xl:h-40 w-full bg-transparent cursor-wait transition-all duration-300 hover:bg-gradient-to-r from-theme-sky via-theme-purple to-theme-red p-[2px] flex items-center justify-center">
                  <nuxt-link to="/plus" class="inner bg-theme-gray-1 w-full h-full rounded-2xl text-white text-base md:text-lg font-semibold tracking-wide flex items-center justify-center">
                    <span>
