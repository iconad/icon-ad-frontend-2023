  ...
  <div v-if="project">
    ...
    <div class="project-content space-y-8">
      ...
      <div class="flex theme-container-lg my-24 " v-if="project && project.detail">
        <div class="w-full space-y-3 long-contnet" v-html="project.detail"></div>
      </div>
      <!-- paragraph -->
      ...
      <div class="projects-grid-warpper mt-2 theme-container-lg">
       <div class="inner w-full">
          <BrandingProjectAssets :assets="project.assets" />
        </div>
      </div>
    ...
    <section class="related-projects mt-24 theme-container-lg" v-if="relatedProjects.length != 0">
      ...
      <BrandingProjectRelatedProjects :projects="relatedProjects" />
...
import Atos from '~/utils/Atos'
  ...
  export default {
    ...
    async fetch() {
      ...
      `https://drupal.icon-ad.com/api/projects/${this.project.id}/brand-related`
      ).then(res => res.json())
    },
